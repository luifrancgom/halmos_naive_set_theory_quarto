...
The principal concept of set theory, the one that in completely axiomatic studies is the principal primitive (undefined) concept, is that of *belonging*`\index{belonging}`{=latex}. If $x$ belongs to $A$ ($x$ is an element of $A$, $x$ is *contained*`\index{contain}`{=latex} in $A$), we shall write 
