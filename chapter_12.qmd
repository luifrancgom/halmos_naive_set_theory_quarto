...
Property (@eq-12-3) is known as the **principle of mathematical induction.**`\index{induction}\index{mathematical induction}`{=latex} We shall now add to this list of properties of $\omega$ two others: 
